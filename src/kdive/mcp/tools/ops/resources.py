...
These handlers own cross-tenant host mutation and drain orchestration for `resources.*`.
Catalog reads stay in `kdive.mcp.tools.catalog.resources`; this module registers only
